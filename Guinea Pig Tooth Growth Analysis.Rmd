...
Tabular descriptive statistics are useful but, as the saying goes, "A picture is worth a thousand words", which leads now to the use of graphical descriptive techniques.  The first of these is a histogram, shown here:

```{r histogram, echo=2:3}
...
```
Another useful plot is the Q-Q Plot, which relates quantiles in the given data to standard quantiles. Here is what such a plot looks like for the tooth growth data:
