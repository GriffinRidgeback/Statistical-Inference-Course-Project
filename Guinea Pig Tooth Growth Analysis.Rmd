...
2. Without knowing the population standard deviation, the margin of error for tooth growth at a 95% confidence interval is __`r round(E, 3)`__ microns.  The true mean has a 95% chance of being in the interval between __`r round(x_bar + c(-E, E), 3)`__ microns.
