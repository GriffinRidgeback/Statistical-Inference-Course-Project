...
The Central Limit Theorem (CLT), and the concept of the sampling distribution, are critical for understanding why statistical inference works.  The CLT says that if you take many repeated samples from a population, and calculate the averages (or sum) of each one, the collection of those averages will be normally distributed.
